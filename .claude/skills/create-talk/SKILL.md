...
- **Paper path** (optional): defaults to `output/paper/main.tex`
...
Save to output/slides/[format]_talk.tex
```
...
```
Prompt: Review the talk at output/slides/[format]_talk.tex.
Check 5 categories:
...
Save to `output/slides/[format]_talk.tex` (e.g., `output/slides/seminar_talk.tex`).
